...
########################################################
#ithubusercontent.com/mattifestation/PSReflect/master/PSReflect.psm1
#
########################################################
...
<#
    .SYNOPSIS
        ...
        Licenmemory module that can be passed to the 'enum',
...
<#
    ...
    .PARAMETER Charset
e calls the SetLastError Win32 API
    ...
    .EXAMPLE
        ...
        $FunctionDefinitions = @(
          (func kerndress($ntdllbase, 'RtlGetCurrentPeb')
